                        ...
                        Commands.sequence(
                            LEDCommands.runSplitWithLEDSection(
                                    ...
                                    new LEDSection(
                                        ...
                                        new NamedLEDPattern(
                                            "blinkLeft",
                                            LedUtil.makeFlash(kLed.TargetingColor, .1)),
                                        interpolateHeight(
                            ...
                            LEDCommands.runSplitWithLEDSection(
                                    ...
                                    new LEDSection(
                                        ...
                                        0,
                                        new NamedLEDPattern(
                                            "blinkIdk2", LedUtil.makeFlash(kLed.AlgaeColor, .1)),
                                        interpolateHeight(
                                            target.superStructureState().elevatorMeters),
                                        "flashy color center"),
                                    new LEDSection(
                                        ...
                                        0,
                                        new NamedLEDPattern(
                                            "blinkIdk1", LedUtil.makeFlash(kLed.AlgaeColor, .1)),
                                        interpolateHeight(
                                            target.superStructureState().elevatorMeters),
                                        "flashy color center"))
                                .onlyIf(
                            ...
                            LEDCommands.runSplitWithLEDSection(
                                    ...
                                    new LEDSection(
                                        ...
                                        new NamedLEDPattern(
                                            "blinkRight",
                                            LedUtil.makeFlash(kLed.TargetingColor, 0.1)),
                                        interpolateHeight(
                                            target.superStructureState().elevatorMeters),
                                        "flashing color on left"),
                                    new LEDSection(
                            ...
                            LEDCommands.runSplitWithLEDSection(
                                    led,
                                    new LEDSection(
                                        0, 0, LedUtil.makeFlash(Color.kYellow, .1), 36, "L1INGS1"),
                                    new LEDSection(
