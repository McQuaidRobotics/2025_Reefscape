...
public class Types {
  public record State(double position, double velocity) implements StructSerializable {
    ...
    public final boolean isNear(State other, double posTolerance, double veloTolerance) {
      return MathUtil.isNear(this.position, other.position, posTolerance)
          && MathUtil.isNear(this.velocity, other.velocity, veloTolerance);
    }
